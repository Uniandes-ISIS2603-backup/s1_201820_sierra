...
public class EspecieResource {
     ...
     * </pre>
     * @return JSONArray {@link EspecieDetailDTO} - Las especies encontrados en la aplicación. Si no hay ninguno retorna una lista vacía.
     */  
    @GET
     ...
     * @return JSON {@link EspecieDetailDTO}  - La especie se a guardado con el atributo id autogenerado.
     ...
     * </code> 
     * </pre>
     * @param id Identificador de la especie que se desea actualizar. Este debe ser una cadena de dígitos.
     ...
     * </code>
     * </pre>
     * @param id Identificador de la especie que se desea borrar. Este debe ser una cadena de dígitos.
     * @throws co.edu.uniandes.csw.sierra.exceptions.BusinessLogicException
     */
    @DELETE
    @Path( "{id: \\d+}" )
