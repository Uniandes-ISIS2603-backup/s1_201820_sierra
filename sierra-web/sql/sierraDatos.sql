...
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (101, '11/24/2017', 2146379);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (102, '12/3/2017', 2843100);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (103, '2/1/2018', 4617331);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (104, '6/23/2017', 715105);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (105, '11/12/2017', 2802294);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (106, '12/9/2017', 3466209);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (107, '1/24/2018', 3573395);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (108, '3/8/2017', 4900605);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (109, '7/23/2017', 3683016);
insert into ADQUISICIONENTITY (id, fecha, valorTotal) values (110, '5/6/2017', 1970169);


/*--Añado las  Calificaciones a las tablas -->*/
...
insert into CALIFICACIONENTITY (id, comentarios, sugerencia, valor, adquisicion_id) values (109, 'Operative value-added pricing structure', 'Web Designer III', 2.42, 109);
insert into CALIFICACIONENTITY (id, comentarios, sugerencia, valor, adquisicion_id) values (110, 'Re-contextualized executive adapter', 'Programmer IV', 1.78, 110);
...
* Mascotas Venta
*/
insert into MascotaVentaEntity(id, precio) values(200, 42000000);
