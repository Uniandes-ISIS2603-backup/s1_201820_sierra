...
/*MASCOTAS*/
        ...
        /*ADOPCION*/
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (112,'MascotaAdoptadaEntity','Kiba','Grande','Femenino',2,'recursos/img/siberiano.jpg','Negro y Blanco',0,1,'1/05/2016',111);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (113,'MascotaAdoptadaEntity','Jacob','Grande','Masculino',3,'recursos/img/Siberiano2.jpg','Negro y Blanco',1,1,'6/23/2015',111,111);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (114,'MascotaAdoptadaEntity','Daju','Grande','Masculino',2,'recursos/img/siberiano3.jpg','Negro y Blanco',0,0,'3/12/2016',111);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (115,'MascotaVentaEntity','Deyeyiah','Grande','Masculino',4,'recursos/img/siberiano4.jpg','Negro y Blanco',0,0,'5/11/2014',111);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (116,'MascotaAdoptadaEntity','Zeus','Grande','Masculino',1,'recursos/img/Alaska.jpg','Blanco y negro',0,0,'6/03/2017',115);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (117,'MascotaVentaEntity','Luna','Mediana','Femenino',2,'recursos/img/border.jpg','Blanco negro',0,1,'5/05/2016',118);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (118,'MascotaAdoptadaEntity','Magdalena','Mediana','Femenino',1,'recursos/img/border2.jpg','Blanco y negro',1,0,'6/11/2017',118,112);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (119,'MascotaAdoptadaEntity','Matias','Pequeño','Masculino',2,'recursos/img/border3.jpg','Blanco y negro',0,0,'12/02/2016',118);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (120,'MascotaAdoptadaEntity','Blanca','Mediana','Femenino',1,'recursos/img/bull.jpg','blanco',0,0,'6/23/2017',119);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (121,'MascotaVentaEntity','Perro','Mediana','Maculino',1,'recursos/img/bull2.jpg','blanco',1,0,'6/23/2017',119,111);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (122,'MascotaAdoptadaEntity','Rocko','Mediana','Masculino',1,'recursos/img/bull3.jpg','blanco',0,1,'6/23/2017',119);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (123,'MascotaVentaEntity','Bolita','Mediana','Femenino',1,'recursos/img/chow.jpg','dorado',1,1,'6/23/2017',117,113);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (124,'MascotaAdoptadaEntity','zorro','pequeño','Masculino',2,'recursos/img/fox.jpg','blanco dorado',0,0,'6/23/2017',120);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (125,'MascotaVentaEntity','Doradita','Mediana','Femenino',1,'recursos/img/golden.jpg','Dorado',0,0,'6/23/2017',112);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (126,'MascotaAdoptadaEntity','pastore','Mediano','Masculino',1,'recursos/img/pastor.jpg','dorado negro',0,0,'6/23/2017',114);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (127,'MascotaVentaEntity','Raka','Mediana','Femenino',3,'recursos/img/pastor2.jpg','dorado negro',0,1,'6/23/2017',114);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (128,'MascotaAdoptadaEntity','Roto','Mediano','Masculino',1,'recursos/img/rott.jpg','dorado negro',1,0,'6/23/2017',116,113);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (129,'MascotaVentaEntity','Manco','Mediana','Masculino',1,'recursos/img/rott2.jpg','dorado negro',0,1,'6/23/2017',116);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (130,'MascotaAdoptadaEntity','Nieve','Mediana','Femenino',1,'recursos/img/samoyedo.jpg','dorado negro',0,0,'6/23/2017',113);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (131,'MascotaVentaEntity','Thor','Mediano','Masculino',1,'recursos/img/samoyedo2.jpg','dorado negro',1,0,'6/23/2017',113,114);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (132,'MascotaAdoptadaEntity','Turron','Pequeño','Masculino',1,'recursos/img/persa.jpg','Blanco',1,1,'6/23/2017',124,111);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (133,'MascotaVentaEntity','Thanos','pequeño','Masculino',1,'recursos/img/persa2.jpg','blanco',0,0,'6/23/1900',124);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (134,'MascotaAdoptadaEntity','Masco','pequeño','Masculino',1,'recursos/img/ruso.jpg','gris',0,0,'6/23/1900',125);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id,cliente_id) values (135,'MascotaVentaEntity','Vocado','pequeño','Masculino',1,'recursos/img/ruso2.jpg','gris',1,0,'6/23/1900',125,112);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (136,'MascotaAdoptadaEntity','Pex','pequeño','Masculino',1,'recursos/img/siames.jpg','multi color',0,0,'6/23/1900',121);
insert into MascotaEntity(id,DType,nombre,tamano,genero,edad,imagen,color,adquirido,esteril,nacimiento,raza_id) values (137,'MascotaAdoptadaEntity','Trynda','pequeño','Masculino',1,'recursos/img/siames2.jpg','multi color',0,0,'6/23/1900',121);
